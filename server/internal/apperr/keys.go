...
const (
	...
	KeyAuditSubdomainNotScannable    = "error.auditSubdomainNotScannable"
	KeyAuditBulkRescanTooMany        = "error.auditBulkRescanTooMany"
	KeyAuditBulkRescanNoneQueued     = "error.auditBulkRescanNoneQueued"
