...
if (!/^[a-z][a-z0-9]*(\.[a-z][a-z0-9]*)+$/.test(applicationId)) {
  throw new Error("CLIENT_APPLICATION_ID must be a lowercase Android package name.");
}
if (applicationId.length > 60) throw new Error("CLIENT_APPLICATION_ID is too long for an Android package name.");
