...
services:
  app:
    image: ghcr.milu.moe/hanlull/hl6:latest
    ...
    environment:
      ...
      CODEPAY_ID: "${CODEPAY_ID:-}"
      CODEPAY_KEY: "${CODEPAY_KEY:-}"
...
| 变量名 | 说明 |
|--------|------|
| `EPAY_URL` | 易支付网关地址，如 `https://pay.example.com` |
| `EPAY_PID` | 商户 ID |
| `EPAY_KEY` | 商户密钥 |
...
# 码支付
CODEPAY_URL=https://codepay.example.com
CODEPAY_ID=1002
CODEPAY_KEY=your-merchant-key
```
...
```bash
# 编辑 docker-compose.prod.yml，将 latest 改为具体版本
image: ghcr.milu.moe/hanlull/hl6:v1.2.0
```
